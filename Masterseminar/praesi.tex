...
\begin{itemize}
\item Referenzsystem (PostGIS\footnote{GIS Erweiterung für PostgreSQL: \url{http://postgis.org}}) %Ist Stand
...
\begin{itemize}
\item Softwarequalität\footnote{[Wall2001]} %ausschreiben
