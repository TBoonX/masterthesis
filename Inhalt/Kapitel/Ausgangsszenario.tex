...
Postgres-XL: Bis zu sechsfache Antwortdauer von PostgreSQL gegenüber Postgres-XL in einem standardisierten TPC-H\footnote{TPC-H: \url{http://www.tpc.org/tpch/}} Benchmark bei Verwendung von vier DataNodes. Abbildung \ref{fig:pgxcversuspgsql} zeigt das Diagramm mit dem genannten Wert.
...
Weit verbreitet ist Simple Features Access, womit räumliche Objekte allgemein für Implementationen in beliebigen Programmiersprachen definiert werden.
Dieser Standard dient der Interoperabilität und effektiven Implementation.
...
Dies wird bei der semantischen Aufbereitung von Webdiensten mit räumlichen Datenkontext deutlich.
...
Für Webdienste mit räumlichen Datenkontext existieren verschiedene Vorgehensweisen zur semantischen Aufbereitung\footnote{In der entsprechenden englischen Literatur wird statt spatial das Wort geospatial verwendet. Weiterhin wird eine Menge von Webdiensten mit räumlichen Datenkontext als Spatial Data Infrastructures (SPI) zusammengefasst.}.
