...
Dies wird speziell durch zusaätzliche Leistungstests beurteilt.
\end{quote}
\begin{description}
...
\begin{description}
\item[Zeitverhalten] Oder auch Laufzeitverhalten genannt, dient allgemein zur Darstellung des Durchsatzes. Die Skalierung des Systems zählt hier dazu.
...
\item[Modifizierbarkeit] Notwendiger Aufwand um Änderungen zum Ziele der Verbesserung und Fehlerbehebung.
