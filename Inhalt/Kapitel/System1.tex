...
Fünf der sechs fileids werden für die beschriebene Anfrage verwendet und die Ergebnisse in den Arbeitsspeicher geladen.
...
11 & 3541 & 98 \\ 			
\end{tabular}
\caption[Testergebnis Lasttest 1]{Testergebnis Lasttest 1}
...
\caption[Auslastung der Knoten 1 bis 6 im ersten Lasttest]{Auslastung der Knoten 1 bis 6 im ersten Lasttest, 14:28-14:48 Uhr}
\label{fig:auslastungTest1}
\end{figure}
\begin{figure}[h!]
\centering
\includegraphics[width=.5\textwidth]{Testergebnisse/jdbc_aggregation_Testlauf_bild2.png}
\caption[Auslastung des Knoten 7 im ersten Lasttest]{Auslastung des Knoten 7 im ersten Lasttest, 14:28-14:48 Uhr}
...
11 & 2375 & 152 \\ 			
\end{tabular}
\caption[Testergebnis Lasttest 1 mit Kartendarstellung]{Testergebnis Lasttest 1 mit Kartendarstellung unter Nutzung des \Gls{umn}}
...
\caption[Auslastung der Knoten 1 bis 6 im ersten Lasttest mit Kartendarstellung]{Auslastung der Knoten 1 bis 6 im ersten Lasttest mit Kartendarstellung, 11:03-11:33 Uhr}
...
\caption[Auslastung des Knoten 7 im ersten Lasttest mit Kartendarstellung]{Auslastung des Knoten 7 im ersten Lasttest mit Kartendarstellung, 11:03-11:33 Uhr}
...
Die Aggregation mit SQL ergab für die PostgreSQL \Gls{vm} 4319ms durchschnittliche Laufzeit.
\begin{table}[h!]
\centering
%\small
\begin{tabular}{c|c|c}
...
11 & 4226 & 110 \\	
\end{tabular}
\caption[Testergebnis Lasttest 1 mit PostgreSQL \Gls{vm}]{Testergebnis Lasttest 1 mit PostgreSQL \Gls{vm}}
...
\caption[Auslastung der VM im ersten Lasttest]{Auslastung der VM im ersten Lasttest, 13:09-13:32 Uhr}
\label{fig:auslastungTest1_pg}
\end{figure}


Die Aggregation mit dem \Gls{umn} ergab für die PostgreSQL \Gls{vm} 2595ms durchschnittliche Laufzeit.
\begin{table}[h!]
\centering
%\small
\begin{tabular}{c|c|c}
...
11 & 2365 & 150 \\	
\end{tabular}
\caption[Testergebnis Lasttest 1 mit Kartendarstellung und PostgreSQL \Gls{vm}]{Testergebnis Lasttest 1 mit Kartendarstellung und PostgreSQL \Gls{vm}}
\label{tbl:ergebnisseTest1PG}
\end{table}
...
\caption[Auslastung der VM im ersten Lasttest mit Kartendarstellung]{Auslastung der VM im ersten Lasttest mit Kartendarstellung, 13:40-14:09 Uhr}
...
Die Testdefinition wurde aus dem ersten Leistungstest übernommen.
...
Diese Definition ist nicht verwendbar, da bei gleichzeitigen parallelen Aufruf Fehler geworfen werden.
