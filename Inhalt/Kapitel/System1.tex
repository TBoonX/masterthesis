...
Die Daten können auch analog des Schema übertragen werden, dies dauert jedoch länger.
...
Somit sind Aussagen zur Leistungsfähigkeit gegenüber dem Ist-Standes treffbar.
...
Userlayer eines Halbjahresplanung besitzt begrenzendes Rechteck, welches im WKT Format wie folgt beschrieben ist: \textit{POLYGON((13.2547868501418 50.7878870616778,13.2833057640198 50.7878870616778,13.2833057640198 50.7935526493687,13.2547868501418 50.7935526493687,13.2547868501418 50.7878870616778))}.
Mit diesem können alle Schläge räumlich gefiltert werden.
...
Die Abfrage und Messung erfolgt mit dem SQL Statement \textit{Select * From n.nsensorlogs Where farmid=1038;} sowie \textit{Explain Verbose Select * From n.nsensorlogs Where farmid=1038;}.
...
Die Karte wird farbig anhand der Metadaten erzeugt.
%Aggregation
...
\textit{nutrients.createcontouring(integer)} auf.%bzw. createcontouringatop(integer)
