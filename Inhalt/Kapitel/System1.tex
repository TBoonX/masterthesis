...
Der Wert der CPU Auslastung geht von null bis fünf, was die Auslastung auf Linux Systemen wiedergibt.
...
%mehrere Durchgänge
%gegenüber stellen
Die Testdefinition orientiert sich an jener von \cite{ba:kurt}.
Es werden 64 Clients simuliert, indem gleichzeitig 64 Threads fünf ausgewählte Kartenbereiche in zufälliger Reihenfolge per WMS abfragen.
...
% -> Userlayer bbox oder kleinen client bauen oder tinos client nutzen und bbox raus holen
...
%\small
\begin{tabular}{c|c}
\textbf{fileid} & \textbf{Anzahl Einträge} \\ \hline %TODO
