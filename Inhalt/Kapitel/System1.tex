...
Diese Definition ist nicht verwendbar, da bei den Coordinators zwei bis sechs ab dem zweiten Aufruf der Funktion diese bis zum Neustart des Coordinator Fehler wirft.
Dabei verlieren die Coordinator die Verbindung zu den DataNodes.
Dies tritt auch auf, wenn man die Anfragen parallel an einen Coordinator verschickt.
Aus diesem Grund wird nur der erste Coordinator verwendet und die Anfragen erfolgen sequenziell.
