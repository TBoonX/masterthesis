...
%UMN und JMeter verwenden - nennen und Beschreiben (Frameworks und Einsatz/Zweck)
Für die Aggregation entsprechend des Anwendungsfalles erfolgt die Aggregation im Rahmen der direkten Darstellung als Karte.
...
Die Abfrage und Messung erfolgt mit dem SQL Befehl Explain Analyze Select.
Damit wird neben der Laufzeit der Aggregation auch die Aufteilung des SQL Statements an die Knoten des Clusters ersichtlich.
Zusätzlich erfolgt die Aggregation in einem gesonderten Test mit dem \Gls{umn}.
Dafür wird ein Mapfile verwendet, welches Kartenausschnitte der Punktdaten darstellt.
