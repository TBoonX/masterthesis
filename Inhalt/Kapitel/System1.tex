...
Die Testergebnisse mit der PostgreSQL \Gls{vm} sind ähnlich zu denen mit dem Postgres-XL Cluster.
969 Sekunden ist hier die durchschnittliche Laufzeit.
\begin{table}[h!]
\centering
%\small
\begin{tabular}{c|C{3.4cm}|C{3.4cm}|c}
...
Ebenso ist die Auslastung der \Gls{vm} ähnlich, wie in Abbildung \ref{fig:auslastungTest2_pg} dargestellt.
Die Auslastung der CPU liegt zwischen 30\%{} und 62\%{}.
