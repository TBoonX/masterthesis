...
%dies kurz darlegen
\textit{Explain Verbose Select} liefert für die fileid 44982 folgenden Query Plan:\\
\textit{Remote Subquery Scan on all (datanode4)  (cost=0.00..7.39 rows=1 width=172)\\
\noindent\hspace*{4mm}%
->  Index Scan using idx\_{}fileid on n.nsensorlogs  (cost=0.00..7.39 rows=1 width=172)\\
\noindent\hspace*{8mm}%
