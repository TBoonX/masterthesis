...
Die Definition der VMs ist in Abbildung \ref{fig:VMAufb} dargestellt.
...
Als Referenzsystem wird PostgreSQL mit PostGIS und R auch auf einer VM mit 2 Prozessorkernen, 3GB RAM und 100GB Festplattenspeicherplatz eingesetzt.
...
Die Schnittstellen sind nicht mehr zu testen, da Postgres-XL und PostgreSQL wie in Abschnitt \ref{subsection:interface} demonstriert direkt Daten austauschen können.
