...
% Dokumentation 3
%install: knappe hinsweise http://www.geomesa.org/2014/05/28/geomesa-quickstart/
%zeit: 0
%funktionsumfang: 1 nennung von ein paar möglichkeiten http://www.geomesa.org/tutorials/
...
Dokumentation & 3 & 23 & zumeist ist auf Community zurückzugreifen & 8 \\ \hline
...
\end{table}
Aus Tabelle \ref{table:nutzwertanalyse-geomesa} ergibt sich ein Nutzwert von 51.
...
%geostatistic: 0 just simple interpolation to a point, possible with R or C++ and GDAL http://postgis.net/docs/manual-2.1/PostGIS_Special_Functions_Index.html
...
Funktionsumfang & 57 & 93 & Geostatistik und Versionierung nicht vorhanden & 19 \\ \hline
