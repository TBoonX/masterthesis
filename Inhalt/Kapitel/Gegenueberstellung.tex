...
Ergo wird eine Inspektion als Prüfmethode verwendet.
...
Dieser Wertungsmaßstab wurde unter Berücksichtigung der Relevanz der jeweiligen Metrik und dem jeweils maximal zu erreichenden Teilnutzwert gewählt.
...
Interoperabilität & 7 & 58 & Implementierungen für beide Schnittstellen notwendig. & 17 \\ \hline
...
Eine solche hohe Anzahl an branches spricht für eine hohe Nutzung und Lebendigkeit des Projektes.
...
\end{figure}
Das GeoMesa Projekt auf GitHub hat nach Abbildung \ref{fig:timeline_contr_geomesa} einen bis vier Stammprogrammierer und ist im zweiten und dritten Quartal mit der doppelten Anzahl an contributors gegenüber den anderen Quartalen fragmentiert.
...
Darin können Mitglieder je nach Beitrag Teile der Entscheidungsorgane der Arbeitsgruppe werden und Zugang zu Ergebnissen dieser erhalten. (vgl. \cite{website:locationtech-about})
...
Jedoch ist die Aktivität der TransLattice Entwickler zu beobachten, da die Gefahr besteht, dass dieses Projekt vom Unternehmen nicht mehr gefördert wird und somit Fehlerbehebungen und Verbesserungen nicht eingepflegt werden und neue PostgreSQL Versionen nicht unterstützt werden.
...
Die granulare Bewertung befindet sich in Anhang \ref{appendix:systembewertung-rasdaman}.
Als Quelle diente dabei \cite{website:rasdaman-features} mit verlinkten Websites des gleichen Domain Namen.
...
\begin{lstlisting}[language=bash,caption={Erster Commit des Projektes Rasdaman},label=lst:rasdamancom1,captionpos=b]
...
Der Großteil der Entwicklung erfolgt somit in einem kleinen Kreis von Programmierern.
