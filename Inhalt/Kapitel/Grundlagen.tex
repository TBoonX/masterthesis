...
Dabei werden die Koordinatenreferenzsysteme, die Objekte und topologischen Informationen geändert.
...
Diese Verknüpfung von Statistik und räumlichen Daten heißt Geostatistik.

%Geostatistik
In den weiteren Ausführungen wird contouring mit dem Spezialfall kriging angewandt.
Der Entwickler war Kriging, welcher diese Transformation zur Vorhersage von Goldvorkommen in Süd Afrika verwendet hat.
