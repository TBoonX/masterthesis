...
\definecolor{LiteraturFarbe}{rgb}{0.0,1.0,0.3}		% Farbe der Links zur Literatur (cite)
\ifAusdruck
\definecolor{InterneLinkfarbe}{rgb}{0.0,0.0,0.0}
\definecolor{ExterneLinkfarbe}{rgb}{0.0,0.0,0.0}
\definecolor{LiteraturFarbe}{rgb}{0.0,0.0,0.0}
\fi
...
\lstloadlanguages{Java,HTML,SQL}
\lstset{
	frame=tb,
	framesep=5pt,
...
%Formatierung Quellcodeverzeichnis
...
% Beschriftung der Figure
\captionsetup[lstlisting]{labelfont={},textfont={}}
